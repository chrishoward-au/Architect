	...
	private function _populate_template_options()
	{
		...
		$meta_box_template[ 'tabs' ][ $i++ ][ 'fields' ] = array(
			...
			array(
				...
				'default' => 'desktop',
				'options' => array(
					array('value' => 'desktop', 'text' => 'Desktop, Tablet landscape - greater than 960 pixels'),
					array('value' => 'tablet-portrait', 'text' => 'Tablet Portrait - 641 to 960 pixels'),
					array('value' => 'smartphone', 'text' => 'Smartphone - 0 to 640 pixels'),
				),
...
//				),
			...
			array(
				'label'   => __('Layout mode', 'pzucd'),
				'id'      => $prefix . 'layout-mode',
				'type'    => 'select',
				'default' => 'masonary',
				'options' => array(
					array('value' => 'masonary', 'text' => 'Masonary'),
					array('value' => 'masonaryVertical', 'text' => 'Masonary Vertical'),
					array('value' => 'fitRows', 'text' => 'Fit rows'),
					array('value' => 'fitColumns', 'text' => 'Fit columns'),
					array('value' => 'cellsByRow', 'text' => 'Cells by row'),
					array('value' => 'cellsByColumn', 'text' => 'Cells by column'),
					array('value' => 'straightDown', 'text' => 'Straight down'),
					array('value' => 'straightAcross', 'text' => 'Straight across'),
				),
