...
class pzucd_Cell_Layouts extends pzucdAdmin {
   ...
   */
	...
	//pzdebug($this->meta_box_layout);
			...
			add_meta_box($this->meta_box_layout['id'], 
				$this->meta_box_layout['title'], 
				array($this,'draw_meta_box'), 
				$this->meta_box_layout['page'], 
				$this->meta_box_layout['context'], 
				$this->meta_box_layout['priority'],
					$this->meta_box_layout
			);

		} // End layouts_meta
		
		protected function draw_meta_box() {
			$this->form = new pzucdForm($this->meta_box_layout);
		}
