...
class pzucd_Cell_Layouts extends pzucdAdmin {

		public $form;
		private $meta_box_layout;
		...
		protected function draw_meta_box($postobj, $pizazz_callback_args) {
				$this->form = new pzucdForm($this->meta_box_layout, $postobj, $pizazz_callback_args);
		}
		...
		public function layouts_meta() {
				...
				$this->meta_box_layout = $this->layout_defaults();
				//pzdebug($this->meta_box_layout);

				$this->populate_layout_options();

				add_meta_box(
								$this->meta_box_layout['id'], $this->meta_box_layout['title'], array($this, 'draw_meta_box'), $this->meta_box_layout['page'], $this->meta_box_layout['context'], $this->meta_box_layout['priority'], $this->meta_box_layout
				);
		}
...
// End layouts_meta
		 ...
		 * @return [type] [description]
		 */
		function populate_layout_options() {
				//		global $this->meta_box_layout;
				 ...
				 * RESPONSIVE
				 * *************** */
				$this->meta_box_layout['tabs'][$i++]['fields'] = array(
						array(
								'label' => __('Responsive', 'pzucd'),
