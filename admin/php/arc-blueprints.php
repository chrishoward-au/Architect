...
'fields'     => array(
  ...
  function pzarc_contents_metabox($meta_boxes = array())
  {
    ...
    $sections[ ] = array(
        ...
        'icon_class' => 'icon-large',
        'icon'       => 'el-icon-check',
        'required'   => array('content_general_content-source', 'equals', 'defaults'),
        'fields'     => array(
            array(
    ...
    $sections[ ] = array(
        'title'      => 'Posts',
        'required'   => array('content_general_content-source', 'equals', 'post'),
        'icon_class' => 'icon-large',
        'icon'       => 'el-icon-list',
        'fields'     => array(
            array(
            ...
            array(
                ...
                'id'     => $prefix . 'custom-taxonomies-section',
                'type'   => 'section',
                'class'  => ' heading',
                'indent' => true
            ),
    ...
    $sections[ ] = array(
        'title'      => 'Pages',
        'required'   => array('content_general_content-source', 'equals', 'page'),
        'icon_class' => 'icon-large',
    ...
    $sections[ ] = array(
        'title'      => 'Galleries',
        'required'   => array('content_general_content-source', 'equals', 'gallery'),
        'icon_class' => 'icon-large',
    ...
    $sections[ ] = array(
        ...
        'required'   => array('content_general_content-source', 'equals', 'cpt'),
        'icon_class' => 'icon-large',
        'icon'       => 'el-icon-wrench',
        'fields'     => array(
            array(
