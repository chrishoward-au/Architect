...
class pzarc_Slides
{
  ...
  {
    add_action('init', array($this, 'create_slides_post_type'));
...
//  }
   ...
   * @return [type] [description]
   */
  public function create_slides_post_type()
  {
if (post_type_exists('pzsp-slides')) {
  return;
}
    $labels = array(
            ...
            'menu_name'          => _x('<span class="dashicons dashicons-slides"></span>Slides', 'pzarc-slides'),
    );
