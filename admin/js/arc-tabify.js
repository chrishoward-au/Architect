...
jQuery(document).ready(function() {
  ...
  var slugdivs_bpsections = ['#blueprint-section-1','#blueprint-section-2','#blueprint-section-3','#blueprint-wireframe-preview'];
  var slugdivs_bpswitcher = ['#contents-selection-settings','#blueprint-settings'];
  var title = 'h3 span';
