...
//      break;
  ...
  //    break;
    ...
    case 'all':
      ...
      pzucd_update_selected($preview_inputs,cell_layout);
...
//      //console.log(sorted);
    ...
    *************/
      ...
      jQuery.each(cell_layout,function(index, value){
        ...
        console.log(cell_layout[index].show);

        if (input_states[index] == true ) {
          $source_target.show();
          cell_layout[index].show = true;
          $source_target.css("width", value+'%');
//          $source_input.val(value);
        } else {
          $source_target.hide();
          cell_layout[index].show = false;
//          $source_input.val('');
        }
        console.log(cell_layout[index].show);
	...
	jQuery(".pzucd-draggable").resizable({
      ...
      cell_layout[zone].width = new_percent;
      console.log(cell_layout);
...
//	});
  ...
  // This doesn't sem at all necessary anymore
...
//	});
  ...
  function pzucd_update_states() {
    var showing = "Showing: ";
    jQuery.each(cell_layout,function(index, value){
      if (value.show)  {
        showing = showing + " "+index+": "+value.width+"%";
      }
    });
    jQuery("p.pzucd-states").text(showing);
...
function pzucd_update_selected($preview_inputs,cell_layout) {
  $preview_inputs.each(function() {
