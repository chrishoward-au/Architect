...
//    var cell_layout = jQuery.parseJSON(jQuery('input#panels_preview-text').val());
...
// Hidden field containing the plugin url
    var plugin_url = jQuery( 'fieldset#_architect-panels_preview .plugin_url' ).text();
...
// Get the current order and widths from the hidden text field attached to preview layout box
    ...
    jQuery( "input\[name='_architect[panels_thumb-position]'" ).on( 'click', function ( e )
    {
...
//	});
    ...
    jQuery( 'input\[name="_architect[panels_background-position]"' ).on( 'click', function ( e )
    {
        var cell_layout = jQuery.parseJSON( jQuery( 'input#panels_preview-text' ).val() );
        pzarc_update_background( cell_layout );
    } );
    ...
    jQuery( 'select#panels_components-to-show-select' ).change(function ( e )
    {
       console.log(this);
        var cell_layout = jQuery.parseJSON( jQuery( 'input#panels_preview-text' ).val() );
...
// Set position of zones
    ...
    jQuery( 'input\[name="_architect[panels_components-position]"' ).on( 'click', function ( e )
    {
        console.log( e );
        var cell_layout = jQuery.parseJSON( jQuery( 'input#panels_preview-text' ).val() );
        pzarc_update_component_location( cell_layout );
...
// This does bugger all at the moment!
    jQuery( 'input\[name="_architect[panels_panel-height-type]"' ).on( 'click', function ( e )
    {
        var cell_layout = jQuery.parseJSON( jQuery( 'input#panels_preview-text' ).val() );
...
//		pzarc_update_components_height(cell_layout);
    ...
    jQuery( 'input#panels_components-widths' ).change( function ( e )
    {
...
//    jQuery('span.value-_pzarc_layout-sections-widths').text(e.srcElement.value);
    ...
    jQuery( 'input#panels_components-nudge-x' ).change( function ( e )
    {
        var cell_layout = jQuery.parseJSON( jQuery( 'input#panels_preview-text' ).val() );
        pzarc_update_components_nudge( cell_layout );
//    jQuery('span.value-_pzarc_layout-sections-nudge-x').text(e.srcElement.value);
    ...
    jQuery( 'input#panels_components-nudge-y' ).change( function ( e )
    {
        var cell_layout = jQuery.parseJSON( jQuery( 'input#panels_preview-text' ).val() );
        pzarc_update_components_nudge( cell_layout );
...
//			jQuery('input[name="_pzarc_layout-field-order-cmb-field-0"]').change();
    ...
    function pzarc_update_status( cell_layout )
    {
        ...
        jQuery( 'input#panels_preview-text' ).val( JSON.stringify( cell_layout ) );
    }
    ...
    {
        var components_state = jQuery( "select#panels_components-to-show-select option" );
...
//        var plugin_url = jQuery( '.field.Pizazz_Layout_Field .plugin_url' ).text();
         ...
         *********************/
        var bgPosition = 'none';
        jQuery( 'input\[name="_architect[panels_background-position]"' ).each(function(){
            if (this.checked){
        ...
        switch (bgPosition)
        {
            ...
            case 'align':
                ...
                var imageHeight = 300 - zonesHeight;
                  //_architect[panels_components-position]
                var sections_position = 'top';
                jQuery( 'input\[name="_architect[panels_components-position]"' ).each(function(){
                    if (this.checked){
    ...
    function pzarc_update_components_container_width( cell_layout )
    {
        ...
        jQuery( '.pzarc-content-area' ).css( 'width', jQuery( 'input#panels_components-widths' ).val() + '%' )
//      break;
    }
...
//      break;
    ...
    function pzarc_update_components_nudge( cell_layout )
    {
         ...
         *********************/
        var nudgexy = [jQuery( 'input#panels_components-nudge-x' ).val(), jQuery( 'input#panels_components-nudge-y' ).val()];
        var sections_position = 'top';
        jQuery( 'input\[name="_architect[panels_components-position]"' ).each(function(){
            if (this.checked){
                sections_position = this.value;
