...
class pzucd_Content_Layouts extends pzucdForm
{
	...
	function __construct()
	{
		...
		if ( is_admin() )
		{
			...
			add_action( 'admin_head', array( $this, 'content_layouts_admin_head' ) );
			add_action( 'admin_enqueue_scripts', array( $this, 'content_layouts_admin_enqueue' ) );
			add_filter( 'manage_ucd-layouts_posts_columns', array( $this, 'add_content_layout_columns' ) );
			add_action( 'manage_ucd-layouts_posts_custom_column', array( $this, 'add_content_layout_column_content' ), 10, 2 );
...
//			}
	...
	/**
	 * [content_layouts_admin_enqueue description]
	 * @param  [type] $hook [description]
	 * @return [type]       [description]
	 */
	public function content_layouts_admin_enqueue( $hook )
	{
	...
	/**
	 * [content_layouts_admin_head description]
	 * @return [type] [description]
	 */
	public function content_layouts_admin_head()
	{
