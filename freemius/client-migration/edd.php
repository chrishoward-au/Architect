<?php
	 ...
	 */
	class Architect_EDD_License_Key extends FS_Client_License_Abstract_v1 {
		/**
		...
		function get() {
			...
			return trim( get_option( 'edd_architect_license_key' ) );
		}
		...
		function set( $license_key ) {
			...
			return update_option( 'edd_architect_license_key', $license_key );
		}
	}
