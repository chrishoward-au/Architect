<?php
	 ...
	 */
	class PZArchitect_EDD_License_Key extends FS_Client_License_Abstract_v1 {
		/**
		...
		function get() {
			...
			return trim( get_option( 'pk_5500130c6efcbdbb28d9754141319' ) );
		}
		...
		function set( $license_key ) {
			...
			return update_option( 'pk_5500130c6efcbdbb28d9754141319', $license_key );
		}
	}
	...
	new FS_EDD_Client_Migration_v1(
		...
		'https://shop.pizazzwp.com',

		// The EDD download ID of your product.
		'16',

		new PZArchitect_EDD_License_Key(),
