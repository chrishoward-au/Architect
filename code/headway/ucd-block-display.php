...
class HeadwayUltimateContentDisplayBlock extends HeadwayBlockAPI {
	...
	function enqueue_action($block_id, $layout) {
		...
		wp_enqueue_style('pzucd-block-css', PZUCD_PLUGIN_URL.'/code/frontend/css/ucd-front.css');

		wp_enqueue_script('jquery');
		wp_enqueue_script('jquery-isotope',PZUCD_PLUGIN_URL.'/code/external/js/jquery.isotope.min.js');
//		wp_enqueue_script('jquery-masonry');
	...
	function js_content($block_id, $layout) {
		...
		if (!isset($settings['pzucd-sections'])) {return null;}
...
//				  	columnWidth : section.width()/columns,
	...
	function content($block) {
		...
		if (!isset($settings['pzucd-sections'])) {echo 'UCD: Nothing to display';return null;}
