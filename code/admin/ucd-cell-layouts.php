...
//			}
	...
	public function cell_layouts_admin_enqueue( $hook )
	{
		...
		if ( 'ucd-layouts' == $screen->id )
		{
			...
			wp_enqueue_style( 'pzucd-admin-cells-css', PZUCD_PLUGIN_URL . '/code/admin/css/ucd-admin-cells.css' );

			wp_enqueue_script( 'jquery-pzucd-metaboxes-cells', PZUCD_PLUGIN_URL . '/code/admin/js/ucd-metaboxes-cells.js', array( 'jquery' ) );
		}
	}
