...
Architect is not a "page builder", a popular genre of plugins. However, it certainly overlaps with some of their functionality. With Architect though, the layouts are built independent of the page. How they are places on the page, and thus the page is built, is up to you. That could be shortcodes, widgets, template tags, action hooks or blocks (Headway).
