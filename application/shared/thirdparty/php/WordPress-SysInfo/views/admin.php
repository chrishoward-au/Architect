...
<div id="sysinfo">
	<div class="wrap">
        ...
        <p style="color:red;">Copy and paste the information below when submitting any support requests to theme or plugin developers.</p>
...
<?php _e( 'PHP ImgMagick Support:', 'sysinfo' ); ?>         <?php echo (class_exists('Gmagick')) ? _e('Yes', 'sysinfo') . "\n" : _e('No', 'sysinfo') . "\n"; ?>
