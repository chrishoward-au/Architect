...
function wknds_crop_focus_styles() {
  ...
  wp_enqueue_style( 'wknds-focus-css', plugin_dir_url(__FILE__) . 'style.css', false, '1.0.0' );
//  wp_enqueue_style( 'wknds-focus-css', $dir . 'style.css', false, '1.0.0' );
  wp_enqueue_script( 'jquery-ui-draggable' );
  wp_enqueue_script( 'wknds-focus-script', plugin_dir_url(__FILE__) . 'script.js', array( 'jquery' ), '', true );
}
