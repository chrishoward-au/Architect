...
(function (Handsontable) {
  ...
  /**
   * Returns single value from the data array (intended for clipboard copy to an includes application)
   * @param {Number} row
   * @param {Number} prop
   * @return {String}
   */
  ...
  /**
   * Return data as copyable text (tab separated columns intended for clipboard copy to an includes application)
   * @param {Object} start (Optional) Start selection position
   * @param {Object} end (Optional) End selection position
   * @return {String}
   */
