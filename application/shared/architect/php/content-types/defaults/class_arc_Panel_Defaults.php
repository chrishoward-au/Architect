<?php
  ...
  class arc_Panel_Defaults extends  arc_Panel_Renderer
  {
  ...
  /**
   * This is the old post renderer. It still might have some old code to reuse. Don't delete yet.
   */
  class arc_Panel_postxxx
  {
...
//      var_dump($data);
  ...
  class arc_Panel_post_Wrapper extends arc_Panel_postxxx
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section, $rsid)
    {
...
//      }
   ...
   */
  class arc_Panel_post_Title extends arc_Panel_postxxx
  {
    /**
  ...
  class arc_Panel_post_Meta extends arc_Panel_postxxx
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section, $rsid)
    {
  ...
  class arc_Panel_post_Image extends arc_Panel_postxxx
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section, $rsid)
    {
...
//      }
  ...
  class arc_Panel_post_bgimage extends arc_Panel_postxxx
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section, $rsid)
    {
  ...
  class arc_Panel_post_Content extends arc_Panel_postxxx
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section, $rsid)
    {
...
//          }
  ...
  class arc_Panel_post_Excerpt extends arc_Panel_postxxx
  {
    /**
     * @param $component
     * @param $panel_def
...
//_panels_design_thumb-position
  ...
  class arc_Panel_post_Custom extends arc_Panel_postxxx
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section, $rsid)
    {
