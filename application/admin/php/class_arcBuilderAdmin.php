<?php
  ...
  class arcBuilderAdmin
  {
    ...
    function __construct()
    {
      if (is_admin()) {
        add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                        "pzarc_add_pagebuilder_metaboxes"), 10, 1);
      }
    }
    ...
    function pzarc_add_pagebuilder_metaboxes($metaboxes)
    {
      ...
      $blueprint_list = array_merge($blueprint_list, array('comments' => __('Comments', 'pzarchitect')));
      ...
      $boxSections[ ] = array(
          ...
          'fields' => array(
              ...
              array('id'                    => '_pzarc_pagebuilder_background',
                    'type'                  => 'background',
