    ...
    function pzarc_add_pagebuilder_metaboxes( $metaboxes ) {
      ...
      $boxSections[ ] = array(
        'desc'   =>
          ...
          '<p class="arc-important">' . __( 'NOTE: For these Blueprints to show, you <strong>must</strong> set the Template to <strong>Architect Builder</strong> in the <strong>Page Attributes</strong> settings at the right.', 'pzarchitect' ) . '</p>',
        'fields' => array(
