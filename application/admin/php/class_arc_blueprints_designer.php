...
//      var_dump($wp_meta_boxes);
    ...
    if (is_admin()) {
      add_action('admin_head', array($this,
                                     'content_blueprints_admin_head'));
      add_action('admin_enqueue_scripts', array($this,
                                                'content_blueprints_admin_enqueue'));
      add_filter('manage_arc-blueprints_posts_columns', array($this,
                                                              'add_blueprint_columns'));
      add_action('manage_arc-blueprints_posts_custom_column', array($this,
                                                                    'add_blueprint_column_content'), 10, 2);

      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_blueprint_tabs'), 10, 1);
//      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
//                                                                      'pzarc_mb_blueprint_presets'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_blueprint_general_settings'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_blueprint_design'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_blueprint_types'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_panels_layout'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_titles_settings'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_meta_settings'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_features_settings'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_body_settings'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
                                                                      'pzarc_mb_customfields_settings'), 10, 1);
      add_action("redux/metaboxes/$this->redux_opt_name/boxes", array($this,
...
//        ), 10, 1);
      ...
      add_filter('views_edit-arc-blueprints', array($this,
...
<div class="pzarc-help-section">
  ...
  public function add_blueprint_columns($columns)
  {
    ...
    $pzarc_insert      = array('_blueprints_short-name' => __('Shortname', 'pzarchitect'),
  ...
  public function add_blueprint_column_content($column, $post_id)
  {
    ...
    switch ($column) {
      ...
      case 'used-on':
        ...
        break;
      case 'layout-type':
        $layout_imgs = array('basic' => array('img' => PZARC_PLUGIN_APP_URL . 'shared/assets/images/metaboxes/layouts-grid.svg'),
...
//      if (!empty($_architect_options[ 'architect_enable_styling' ])) {
    $fields = array(array('id' => $prefix . 'tabs',
                          'type' => 'tabbed',
                          'default' => 'layout',
                          'options' => array('layout' => '<span class="pzarc-tab-title">' . __('Blueprint', 'pzarchitect') . '</span>',
...
//      }
    ...
    $sections['settings-chooser'] = array(//          'title'      => __('General Settings', 'pzarchitect'),
                                          ...
                                          'icon' => 'el-icon-home',
                                          'fields' => $fields);
    $metaboxes[]                  = array('id' => $prefix . 'blueprints',
...
//    }
  ...
  function pzarc_mb_blueprint_general_settings($metaboxes, $defaults_only = false)
  {
    ...
    $sections['_general_bp'] = array('fields' => array(array('id' => $prefix . 'short-name',
    ...
    if (!$_architect_options['architect_enable_styling']) {
      $sections['_general_bp']['fields'][] = array('id' => $prefix . 'headway-styling-message',
    ...
    if (!$animation_state) {
      $sections['_general_bp']['fields'][] = array('id' => $prefix . 'animation-message',
    ...
    $sections['_general_bp']['fields'][] = array('title' => __('Intended Device', 'pzarchitect'),
                                                 ...
                                                 'default' => '',
                                                 'options' => array('' => __('Any', 'pzarchitect'),
                                                                    'tablet' => __('Tablet', 'pzarchitect'),
                                                                    'phone' => __('Phone', 'pzarchitect'),),
                                                 'hint' => array('title' => __('Device', 'pzarchitect'),
    ...
    $sections['_general_bp']['fields'][] = array('title' => 'Getting help',
                                                 'id' => $prefix . 'help-info',
                                                 'type' => 'raw',
                                                 'indent' => false,
    ...
    $metaboxes[] = array('id' => $prefix . 'layout-general-settings',
  ...
  function pzarc_mb_blueprint_design($metaboxes, $defaults_only = false)
  {
    ...
    /** SECTIONS */
    $icons     = array(0 => 'el-icon-th-large',
                       1 => 'el-icon-th',
                       2 => 'el-icon-th-list');
    $modes[0]  = array('basic' => __('Basic', 'pzarchitect'),
    ...
    $modes[1]  = array('basic' => __('Grid/Single', 'pzarchitect'),
                       'masonry' => __('Masonry', 'pzarchitect'),
                       'table' => __('Tabular', 'pzarchitect'),
                       'accordion' => __('Accordion', 'pzarchitect'),
                       //          'fitRows'         => 'Fit rows',
    ...
    for ($i = 0; $i < 1; $i++) {
      $sections['_section' . ($i + 1)] = array('title' => __('Design', 'pzarchitect'),
                                               'show_title' => true,
            ...
            <br>Note: The term Posts is used but refers generically to any WordPress post type or custom post type.', 'pzarchitect') . '</p>',
                                               'icon_class' => 'icon-large',
                                               'icon' => $icons[$i],
                                               'fields' => array(array('title' => __('Layout type', 'pzarchitect'),
...
', 'pzarchitect')),),
                                                                 array('id' => $prefix . 'section-' . $i . '-panels-heading',
                                                                       'title' => __('General panels settings', 'pzarchitect'),
                                                                       'type' => 'section',
                                                                       'indent' => true,),
                                                                 array('title' => __('Limit posts', 'pzarchitect'),
                                                                 ...
                                                                 array('title' => __('Limit number of posts to show to', 'pzarchitect'),
                                                                       ...
                                                                       'required' => array($prefix . 'section-' . $i . '-panels-limited',
                                                                                           'equals',
                                                                                           true)),
                                                                 array('title' => __('Fixed width panels', 'pzarchitect'),
                                                                       'id' => $prefix . 'section-' . $i . '-panels-fixed-width',
                                                                       'type' => 'switch',
                                                                       'on' => __('Yes', 'pzarchitect'),
                                                                       'off' => __('No', 'pzarchitect'),
                                                                       'default' => false,),
                                                                 array('id' => $prefix . 'section-' . $i . '-columns-heading',
                                                                       'title' => __('Panels across', 'pzarchitect'),
                                                                       'type' => 'section',
                                                                       'indent' => true,
                                                                       'required' => array($prefix . 'section-' . $i . '-panels-fixed-width',
                                                                                           'equals',
                                                                                           false)),
                                                                 array('title' => __('Wide screen', 'pzarchitect'),
                                                                       ...
                                                                       'max' => 10,
                                                                       'display_value' => 'label'),
                                                                 array('title' => __('Medium screen', 'pzarchitect'),
                                                                       ...
                                                                       'max' => 10,
                                                                       'display_value' => 'label'),
                                                                 array('title' => __('Narrow screen', 'pzarchitect'),
                                                                       ...
                                                                       'max' => 10,
                                                                       'display_value' => 'label'),
                                                                 array('id' => $prefix . 'section-' . $i . '-panel-width-heading',
                                                                 ...
                                                                 array('title' => __('Narrow screen', 'pzarchitect'),
                                                                       ...
                                                                       'step' => 1,
                                                                       'display_value' => 'label'),
                                                                 array('title' => __('Justify panels', 'pzarchitect'),
                                                                       'id' => $prefix . 'section-' . $i . '-panels-fixed-width-justify',
                                                                       'type' => 'button_set',
                                                                       'options' => array('justify-content: flex-start;' => 'Start',
                                                                                          'justify-content: flex-end;' => 'End',
                                                                                          'justify-content: center;' => 'Centre',
                                                                                          'justify-content: space-between;' => 'Space between',
                                                                                          'justify-content: space-around;' => 'Space around',),
                                                                       'default' => 'justify-content: space-between;',
                                                                       'required' => array(array($prefix . 'section-' . $i . '-panels-fixed-width',
                                                                                                 'equals',
                                                                                                 true),
                                                                                           array($prefix . 'section-0-layout-mode',
                                                                                                 '=',
                                                                                                 'basic')),
                                                                       'subtitle' => __('These are the standard Flexbox justification options', 'pzarchitect')),
                                                                 array('title' => __('Stretch panels to fill', 'pzarchitect'),
                                                                       ...
                                                                       'required' => array(array($prefix . 'section-' . $i . '-panels-fixed-width',
                                                                                           ...
                                                                                           array($prefix . 'section-0-layout-mode',
                                                                                                 '=',
                                                                                                 'basic')),),
                                                                 array('id' => $prefix . 'section-' . $i . '-panels-settings-heading',
                                                                       'title' => __('Panel dimensions', 'pzarchitect'),
                                                                       'type' => 'section',
                                                                       'indent' => true,),
                                                                 array('title' => __('Minimum panel width', 'pzarchitect'),
                                                                 ...
                                                                 array('title' => __('Panel Height Type', 'pzarchitect'),
                                                                       ...
                                                                       'options' => array('none' => __('Fluid', 'pzarchitect'),
                                                                 ...
                                                                 array('title' => __('Panel Height px', 'pzarchitect'),
                                                                       'id' => '_panels_settings_' . 'panel-height',
                                                                       'type' => 'dimensions',
                                                                       //          'class'=> 'arc-field-advanced' ,
                                                                       'required' => array(array('_panels_settings_' . 'panel-height-type',
                                                                                                 '!=',
                                                                                                 'none'),
                                                                 ...
                                                                 array('title' => __('Panel margins', 'pzarchitect'),
                                                                 ...
                                                                 array('id' => $prefix . 'section-' . $i . '-panels-margins-guttered',
                                                                       'type' => 'switch',
                                                                       'on' => __('Yes', 'pzarchitect'),
                                                                       'off' => __('No', 'pzarchitect'),
                                                                       'default' => true,
                                                                       'title' => __('Exclude top/left/right margins on outer panels', 'pzarchitect'),
                                                                       'required' => array($prefix . 'section-' . $i . '-layout-mode',
                                                                                           '=',
                                                                                           'basic'),),
                                                                 array('id' => $prefix . 'section-' . $i . '-blueprint-settings-heading',
                                                                       'title' => __('Blueprint settings', 'pzarchitect'),
                                                                       'type' => 'section',
                                                                       'indent' => true,),
                                                                 array('id' => $prefix . 'blueprint-width',
                                                                       'type' => 'dimensions',
                                                                 ...
                                                                 array('id' => $prefix . 'blueprint-align',
                                                                       'type' => 'button_set',
                                                                       'select2' => array('allowClear' => false),
                                                                 ...
                                                                 array('title' => 'Page title',
                                                                       ...
                                                                       'off' => 'No',
                                                                       'default' => false),
                                                                 array('title' => 'Hide archive title prefix',
                                                                       ...
                                                                       'off' => 'No',
                                                                       'default' => false,
                                                                       'required' => array($prefix . 'page-title',
                                                                                           '=',
                                                                                           true)),
                                                                 array('title' => 'Show archive description',
...
// TODO: need to get styling to take
      ...
      $sections['_styling_general'] = array('title' => 'Blueprint styling',
                                            'show_title' => false,
                                            'icon_class' => 'icon-large',
                                            'icon' => 'el-icon-brush',
...
//                    'default' => 'none'
//                ),
                                                array('title' => __('Blueprint', 'pzarchitect'),
       ...
       * CUSTOM CSS
       */
      $sections['_bp_custom_css'] = array('id' => 'bp-custom-css',
                                          'title' => __('Custom CSS', 'pzarchitect'),
                                          'icon_class' => 'icon-large',
                                          'icon' => 'el-icon-wrench',
                                          'fields' => array(array('id' => $prefix . 'blueprint-custom-css',
                                                                  'type' => 'ace_editor',
                                                                  'title' => __('Custom CSS', 'pzarchitect'),
                                                                  'mode' => 'css',
...
//      $file_contents          = file_get_contents(PZARC_DOCUMENTATION_PATH . PZARC_LANGUAGE . '/using-blueprints.md');
    ...
    $sections['_help'] = array('title' => 'Help',
                               'icon_class' => 'icon-large',
                               'icon' => 'el-icon-question-sign',
                               'fields' => array(array('title' => __('Enabling styling tabs', 'pzarchitect'),
                                                 ...
                                                 array('title' => __('Enabling animation tab', 'pzarchitect'),
                                                 ...
                                                 array('title' => __('Displaying Blueprints', 'pzarchitect'),
                                                       ...
                                                       'pzarchitect'),
                                                 array('title' => __('Blueprint styling', 'pzarchitect'),
                                                       'id' => $prefix . 'help',
                                                       'type' => 'raw',
                                                       'markdown' => false,
                                                       //  'class' => 'plain',
                            ...
                            '),
                                                 array('title' => __('Online documentation', 'pzarchitect'),
    ...
    $metaboxes[] = array('id' => 'layout-settings',
  ...
  function pzarc_mb_blueprint_types($metaboxes, $defaults_only = false)
  {
    ...
    $prefix                 = '_blueprints_'; // declare prefix
    $sections               = array();
    $sections['_tabular']   = array('title' => __('Tabular settings', 'pzarchitect'),
                                    'show_title' => true,
                                    'icon_class' => 'icon-large',
                                    ...
                                    'fields' => array(array('id' => $prefix . 'section-0-table-column-titles',
                                                            'title' => __('Table column titles', 'pzarchitect'),
                                                            'type' => 'multi_text',
                                                            'show_empty' => false,
                                                            'add_text' => 'Add a title',
                                                            'default' => array(),)));
    $sections['_accordion'] = array('title' => __('Accordion settings', 'pzarchitect'),
                                    'show_title' => true,
                                    'icon_class' => 'icon-large',
                                    'icon' => 'el-icon-adjust-alt',
                                    'fields' => array(array('title' => __('Accordion open', 'pzarchitect'),
                                                      ...
                                                      array('id' => $prefix . 'section-0-accordion-titles',
    ...
    $sections['_slidertabbed'] = array('title' => __('Sliders & Tabbed settings', 'pzarchitect'),
                                       'show_title' => true,
                                       'icon_class' => 'icon-large',
                                       'icon' => 'el-icon-adjust-alt',
                                       //          'desc'       => 'When the navigation type is set to navigator, presentation will always be in a slider form. You can have multiple navigators on a page, thus multiple sliders.',
                                       'fields' => array(array('id' => $prefix . 'slider-engine',
                                                               'title' => __('Slider engine', 'pzarchitect'),
                                                               'type' => 'button_set',
                                                               'default' => 'slick',
                                                               'options' => apply_filters('arc-slider-engine', array()),
                                                               'required' => array(array($prefix . 'section-0-layout-mode',
                                                                                         '!=',
                                                                                         'basic'),
                                                                                   array($prefix . 'section-0-layout-mode',
                                                                                         '!=',
                                                         ...
                                                         array('title' => 'Width type',
                                                               'id' => $prefix . 'navtabs-width-type',
                                                               'type' => 'button_set',
                                                               'default' => 'fluid',
                                                               'options' => array('fluid' => 'Fluid',
                                                                                  'even' => 'Even',
                                                                                  'fixed' => 'Fixed'),
                                                               'required' => array(array($prefix . 'navigator-position',
                                                                                         '!=',
                                                                                         'left'),
                                                                                   array($prefix . 'navigator-position',
                                                                                         '!=',
                                                                                         'right')),
                                                         ...
                                                         array('id' => $prefix . 'navtabs-margins-compensation',
                                                               'type' => 'dimensions',
                                                               'units' => array('%',
                                                                                'px',
                                                                                'em'),
                                                               ...
                                                               'required' => array(array($prefix . 'navtabs-width-type',
                                                                                         'contains',
                                                                                         'even'),),),
                                                         array('id' => $prefix . 'navtabs-width',
                                                               'type' => 'dimensions',
                                                               'units' => array('%',
                                                                                'px',
                                                                                'em'),
                                                               ...
                                                               'required' => array(array($prefix . 'navtabs-width-type',
                                                                                         'contains',
                                                                                         'fixed'),),),
                                                         array('id' => $prefix . 'navtabs-maxlen',
                                                               'type' => 'spinner',
                                                         ...
                                                         array('title' => 'Text overflow',
                                                               ...
                                                               'type' => 'button_set',
                                                               'default' => '',
                                                               'required' => array($prefix . 'navtabs-textwrap',
                                                                                   '!=',
                                                                                   'break-word'),
                                                               'options' => array('' => 'Default',
                                                                                  'visible' => 'Visible',
                                                         ...
                                                         array('id' => $prefix . 'section-navtabs-end',
                                                               'type' => 'section',
                                                               'indent' => false,
                                                               'required' => array(array($prefix . 'section-0-layout-mode',
                                                                                         '=',
                                                                                         'tabbed'),),),
                                                         array('title' => __('Layout', 'pzarchitect'),
                                                         ...
                                                         array('title' => 'Position',
                                                               ...
                                                               'height' => 75,
                                                               'options' => array('bottom' => array('alt' => 'Bottom',
                                                         ...
                                                         array('title' => 'Horizontal alignment',
                                                         ...
                                                         array('title' => 'Sizing',
                                                               ...
                                                               'required' => array(array($prefix . 'navigator',
                                                                                   ...
                                                                                   array($prefix . 'navigator',
                                                                                         '!=',
                                                                                         'labels'),)),
                                                         array('title' => 'Thumb dimensions',
                                                               'id' => $prefix . 'navigator-thumb-dimensions',
                                                               'type' => 'dimensions',
                                                               'default' => array('width' => '50px',
                                                                                  'height' => '50px'),
                                                               'units' => 'px',
                                                               'required' => array(array($prefix . 'navigator',
                                                                                         '=',
                                                                                         'thumbs'),)),
                                                         array('title' => 'Slide Pager',
                                                               ...
                                                               'required' => array($prefix . 'section-0-layout-mode',
                                                                                   '=',
                                                                                   'slider'),),
                                                         //                            array(
                                                         ...
                                                         //                                )
                                                         //          ),
                                                         array('title' => 'Navigation skip button',
                                                               ...
                                                               'required' => array(array($prefix . 'section-0-layout-mode',
                                                                                   ...
                                                                                   array($prefix . 'navigator',
                                                                                         '=',
                                                                                         'thumbs'),)),
                                                         array('id' => $prefix . 'navigator-skip-thumbs',
                                                               ...
                                                               'required' => array(array($prefix . 'section-0-layout-mode',
                                                                                   ...
                                                                                   array($prefix . 'navigator',
                                                                                         '=',
                                                                                         'thumbs'),)),
                                                         array('title' => 'Continuous thumbs',
                                                               'id' => $prefix . 'navigator-continuous',
                                                               'type' => 'button_set',
                                                               'default' => 'continuous',
                                                               'options' => array('off' => __('No', 'pzarchitect'),
                                                               ...
                                                               'required' => array(array($prefix . 'section-0-layout-mode',
                                                                                   ...
                                                                                   array($prefix . 'navigator',
                                                                                         '=',
                                                                                         'thumbs'),)),
                                                         array('id' => $prefix . 'section-navlayout-end',
                                                               'type' => 'section',
                                                               'indent' => false,),
                                                         /** TRANSITIONS
                                                          ******************/

                                                         array('title' => __('Transitions timing', 'pzarchitect'),
    ...
    $sort_fields = apply_filters('arc_masonry_sorting', array_merge(array('Standard' => array('random' => __('Random', 'pzarchitect'),
                                                                                              ...
                                                                                              '.author' => __('Author', 'pzarchitect'))), array('Custom Fields' => $this->custom_fields)));
//      global $pzarc_masonry_filter_taxes;
    ...
    $sections['_masonry'] = array('title' => __('Masonry settings', 'pzarchitect'),
                                  'icon_class' => 'icon-large',
                                  'icon' => 'el-icon-adjust-alt',
                                  'fields' => array(array('title' => __('Animation duration (ms)', 'pzarchitect'),
                                                    ...
                                                    array('title' => __('Stagger animation duration (ms)', 'pzarchitect'),
                                                    ...
                                                    array('title' => __('Features', 'pzarchitect'),
                                                          ...
                                                          'default' => array(),
                                                          'desc' => __('', 'pzarchitect')),
                                                    array('title' => __('Packed masonry', 'pzarchitect'),
                                                          'id' => '_blueprints_masonry-full-section-open',
                                                          'type' => 'section',
                                                          'required' => array('_blueprints_masonry-features',
                                                                              'contains',
                                                                              'bidirectional'),
                                                          'indent' => true,
                                                    ...
                                                    array('id' => '_blueprints_masonry-packed-section-close',
                                                          'type' => 'section',
                                                          'indent' => false,),
                                                    array('title' => __('Filtering and Sorting Controls', 'pzarchitect'),
                                                          ...
                                                          'required' => array('_blueprints_masonry-features',
                                                                              ...
                                                                              'ing'),
                                                          'indent' => true,),
                                                    array('title' => __('Controls location', 'pzarchitect'),
                                                          'id' => '_blueprints_masonry-filtering-controls-location',
                                                          'type' => 'button_set',
                                                          'default' => 'top',
                                                          'options' => array('top' => __('Top', 'pzarchitect'),
                                                                             'right' => __('Right', 'pzarchitect'),
                                                    ...
                                                    array('title' => __('Controls width (%)', 'pzarchitect'),
                                                    ...
                                                    array('id' => '_blueprints_masonry-controls-section-close',
                                                          'type' => 'section',
                                                          'indent' => false,),

                                                    // Infinite scroll options: Show progress
                                                    // Sorting: Choose what on (title, date, cat, tag) and order
                                                    array('title' => __('Sorting', 'pzarchitect'),
                                                          'id' => '_blueprints_masonry-sorting-section-open',
                                                          'type' => 'section',
                                                          'indent' => true,
                                                          'required' => array($prefix . 'masonry-features',
                                                                              'contains',
                                                                              'sorting'),),
                                                    array('title' => __('Sort fields', 'pzarchitect'),
                                                    ...
                                                    array('title' => __('Numeric sort fields', 'pzarchitect'),
                                                    ...
                                                    array('title' => __('Date sort fields', 'pzarchitect'),
                                                    ...
                                                    array('id' => '_blueprints_masonry-sorting-section-close',
                                                          'type' => 'section',
                                                          'indent' => false,),
                                                    /**
                                                     * filtering
                                                     **/
                                                    array('title' => __('Filtering', 'pzarchitect'),
                                                          ...
                                                          'required' => array('_blueprints_masonry-features',
                                                                              ...
                                                                              'filtering'),
                                                          'indent' => true,),
                                                    array('title' => __('Taxonomies', 'pzarchitect'),
                                                    ...
                                                    array('title' => __('Allow multiple filter terms', 'pzarchitect'),
                                                          'id' => '_blueprints_masonry-filtering-allow-multiple',
                                                          'type' => 'button_set',
                                                          'default' => 'multiple',
                                                          'options' => array('multiple' => __('Yes', 'pzarchitect'),
                                                    ...
                                                    array('id' => $prefix . 'masonry-filtering-section-close',
                                                          'type' => 'section',
                                                          'indent' => false,),));

    foreach ($pzarc_masonry_filter_taxes as $pzarc_tax) {

      $sections['_masonry']['fields'][] = array('title' => __('Filter on ', 'pzarchitect') . ucwords(str_replace(array('_',
                                                                                                                       '-'), ' ', $pzarc_tax)),
      ...
      $sections['_masonry']['fields'][] = array('title' => __('Set default terms ', 'pzarchitect'),
                                                'id' => '_blueprints_masonry-filtering-set-defaults-' . $pzarc_tax,
                                                'type' => 'button_set',
                                                'default' => 'no',
                                                'options' => array('no' => __('No', 'pzarchitect'),
                                                                   'yes' => __('Yes', 'pzarchitect'),),
                                                'required' => array('_blueprints_masonry-features',
                                                                    'contains',
                                                                    'filtering'),
                                                'subtitle' => __('Control what terms are shown.', 'pzarchitect'),);
      $sections['_masonry']['fields'][] = array('title' => __('Default selected terms', 'pzarchitect'),
                                                ...
                                                'args' => array('taxonomies' => $pzarc_tax,
                                                                'hide_empty' => false),
                                                'required' => array('_blueprints_masonry-filtering-set-defaults-' . $pzarc_tax,
                                                                    'equals',
                                                                    'yes'),
                                                'subtitle' => __('Select which terms to show by default.', 'pzarchitect'));

      $sections['_masonry']['fields'][] = array('title' => __('Limit ', 'pzarchitect'),
                                                ...
                                                'required' => array('_blueprints_masonry-features',
                                                                    ...
                                                                    'filtering'),
                                                'subtitle' => __('Control what terms are shown.', 'pzarchitect'),);
      $sections['_masonry']['fields'][] = array('title' => __('Inclusions/Exclusions', 'pzarchitect'),
                                                'id' => '_blueprints_masonry-filtering-incexc-' . $pzarc_tax,
                                                'type' => 'select',
                                                'multi' => true,
                                                'data' => 'terms',
                                                'default' => array(),
                                                'required' => array('_blueprints_masonry-filtering-limit-' . $pzarc_tax,
                                                                    '!=',
                                                                    'none'),
                                                'args' => array('taxonomies' => $pzarc_tax,
                                                                'hide_empty' => false));
      $sections['_masonry']['fields'][] = array('id' => '_blueprints_masonry-filtering-section-close-' . $pzarc_tax,
                                                'type' => 'section',
                                                'indent' => false,);
    }
...
//die();
    ...
    /** PAGINATION  */
    $sections['_pagination'] = array('title' => 'Pagination',
                                     'icon_class' => 'icon-large',
                                     'icon' => 'el-icon-chevron-right',
                                     'fields' => array(array('title' => 'Pagination',
                                                       ...
                                                       array('title' => __('Settings', 'pzarchitect'),
                                                             'id' => '_blueprint_pagination-settings-section',
                                                             'type' => 'section',
                                                             'indent' => true,
                                                             'required' => array('_blueprints_pagination',
                                                                                 'equals',
                                                                                 true),),
                                                       array('title' => __('Posts per page', 'pzarchitect'),
                                                       ...
                                                       array('id' => '_blueprints_pager-location',
                                                             'title' => __('Pagination location', 'pzarchitect'),
                                                             'type' => 'select',
                                                             'select2' => array('allowClear' => false),
                                                             'default' => 'bottom',
                                                             'options' => array('bottom' => 'Bottom',
                                                                                'top' => 'Top',
                                                                                'both' => 'Both'),),
                                                       array('id' => '_blueprints_pager',
                                                             ...
                                                             'options' => array(//                    'none'     => 'None',
                                                                                ...
                                                                                'names' => 'Post names',
                                                                                'pagenavi' => 'PageNavi',),),
                                                       array('id' => '_blueprints_pager-single',
                                                             ...
                                                             'options' => array(//                    'none'     => 'None',
                                                                                ...
                                                                                'names' => 'Post names',
                                                                                'pagenavi' => 'PageNavi',),),
                                                       array('id' => '_blueprints_pager-archives',
                                                             ...
                                                             'options' => array(//                    'none'     => 'None',
                                                                                ...
                                                                                'names' => 'Post names',
                                                                                'pagenavi' => 'PageNavi',),),
                                                       array('id' => '_blueprints_pager-custom-prev',
                                                             'title' => __('Custom text for Previous', 'pzarchitect'),
                                                             'type' => 'text',
                                                             'default' => '',),
                                                       array('id' => '_blueprints_pager-custom-next',
                                                             'title' => __('Custom text for Next', 'pzarchitect'),
                                                             'type' => 'text',
                                                             'default' => '',),
                                                       array('id' => '_blueprint_pagination-settings-section-end',
                                                             'type' => 'section',
                                                             'indent' => false,
                                                             'required' => array('_blueprints_pagination',
                                                                                 'equals',
...
// TODO: need to get styling to take
      ...
      $sections['_styling_slidertabbed'] = array('title' => 'Sliders & Tabbed styling',
                                                 'show_title' => false,
                                                 'icon_class' => 'icon-large',
                                                 'icon' => 'el-icon-brush',
                                                 'fields' => array(

                                                     array('title' => __('Navigator container', 'pzarchitect'),
                                                           'id' => $prefix . 'blueprint-nav-container-css-heading',
                                                           'type' => 'section',
                                                           'indent' => true,
                                                           'subtitle' => 'Classes: ' . implode(', ', array('.arc-slider-nav',
                                                                                                           '.pzarc-navigator')),
                                                     ...
                                                     array('title' => __('Navigator items', 'pzarchitect'),
                                                     ...
                                                     array('title' => __('Navigator item hover', 'pzarchitect'),
                                                     ...
                                                     array('title' => __('Navigator active item', 'pzarchitect'),
      ...
      $thisSection                  = 'masonry';
      $sections['_styling_masonry'] = array('id' => 'masonry-css',
                                            'title' => 'Masonry styling',
                                            'icon_class' => 'icon-large',
                                            'icon' => 'el-icon-brush',
                                            'fields' => array(array('title' => __('Filtering and sorting section', 'pzarchitect'),
                                                              ...
                                                              array('title' => __('Buttons', 'pzarchitect'),
                                                              ...
                                                              array('title' => __('Selected', 'pzarchitect'),
                                                              ...
                                                              array('title' => __('Hover', 'pzarchitect'),
                                                              ...
                                                              array('title' => __('Clear All and Defaults button', 'pzarchitect'),
      ...
      $sections['_styling_accordion'] = array('id' => 'accordion-css',
                                              'title' => 'Accordion styling',
                                              'icon_class' => 'icon-large',
                                              'icon' => 'el-icon-brush',
                                              'fields' => array(array('title' => __('Titles', 'pzarchitect'),
                                                                ...
                                                                array('title' => __('Opened', 'pzarchitect'),
      ...
      $thisSection                    = 'tabular';
      $sections['_styling_tabular']   = array('id' => 'tabular-css',
                                              'title' => 'Tabular styling',
                                              'icon_class' => 'icon-large',
                                              'icon' => 'el-icon-brush',
                                              'fields' => array(array('title' => __('Headings', 'pzarchitect'),
                                                                ...
                                                                array('title' => __('Odd rows', 'pzarchitect'),
                                                                ...
                                                                array('title' => __('Even rows', 'pzarchitect'),
    ...
    $metaboxes[] = array('id' => 'type-settings',
  ...
  function pzarc_mb_blueprint_content_selection($metaboxes, $defaults_only = false)
  {
    ...
    $prefix               = '_content_general_'; // declare prefix
    $sections['_general'] = array('title' => 'Source',
                                  'icon_class' => 'icon-large',
                                  'icon' => 'el-icon-file',
                                  'fields' => array(array('title' => __('Content source', 'pzarchitect'),
    ...
    $sections['_settings']['fields'][] = array('title' => __('Custom field sort', 'pzarchitect'),
                                               'id' => $prefix . 'sort-section',
                                               'type' => 'section',
                                               'indent' => true,
                                               'required' => array('_content_general_orderby',
                                                                   'equals',
                                                                   'custom'));
    $sections['_settings']['fields'][] = array('type' => 'select',
    ...
    $sections['_content_customfields'] = array('title' => 'Custom field filtering',
                                               'icon_class' => 'icon-large',
                                               'icon' => 'el-icon-wrench',
                                               'fields' => array(array('title' => 'Developer information',
                                                                 ...
                                                                 array('title' => __('Filter match requirement', 'pzarchitect'),
                                                                       'id' => '_blueprints_content-fields-filter-jointype',
                                                                       'type' => 'button_set',
                                                                       'default' => 'AND',
                                                                       'options' => array('AND' => 'Must match ALL',
                                                                                          'OR' => 'May match ANY'),
                                                                       'desc' => __('Each filter is optional. Leave the field empty to ignore it.', 'pzarchitect'))));
    for ($cfi = 1; $cfi <= 3; $cfi++) {
      $sections['_content_customfields']['fields'][] = array('title' => __('Filter field ' . $cfi, 'pzarchitect'),
                                                             'id' => '_blueprints_content-fields-filter-section' . $cfi,
                                                             'type' => 'section',
                                                             'indent' => true,);
      $sections['_content_customfields']['fields'][] = array('type' => 'select',
                                                             'title' => 'Field',
      ...
      $sections['_content_customfields']['fields'][] =
          ...
          array('id' => '_blueprints_content-fields-filter-section-end' . $cfi,
                'type' => 'section',
                'indent' => false,);
    }
    ...
    $sections['_content_help'] = array('title' => 'Help',
                                       'icon_class' => 'icon-large',
                                       'icon' => 'el-icon-question-sign',
                                       'fields' => array(

                                           array('title' => __('Snippets', 'pzarchitect'),
...
You can use them however you like though, e.g Testimonials, FAQs, Features, Contacts, etc.
    ...
    $metaboxes[] = array('id' => 'content-selections',
  ...
  function pzarc_mb_panels_layout($metaboxes, $defaults_only = false)
  {
    ...
    $sections   = array();
    $sections[] = array('title' => __('Content Panels Layout ', 'pzarchitect'),
                        'show_title' => false,
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-adjust-alt',
                        'fields' => array(array('title' => __('Components to show', 'pzarchitect'),
                                                ...
                                                'default' => array('title',
                                                                   ...
                                                                   'meta1',
                                                                   'image'),
                                                'options' => array('title' => __('Title', 'pzarchitect'),
                                                ...
                                                'hint' => array('title' => __('Components to show', 'pzarchitect'),
                                          ...
                                          array('title' => __('Layout', 'pzarchitect'),
                                                ...
                                                'default' => json_encode(array('title' => array('width' => 100,
                                                                                                'show' => true,
                                                                                                'name' => 'title'),
                                                                               'meta1' => array('width' => 100,
                                                                                                'show' => true,
                                                                                                'name' => 'meta1'),
                                                                               'image' => array('width' => 25,
                                                                                                'show' => true,
                                                                                                'name' => 'image'),
                                                                               'excerpt' => array('width' => 75,
                                                                                                  'show' => true,
                                                                                                  'name' => 'excerpt'),
                                                                               //                                            'caption' => array('width' => 100, 'show' => false),
                                                                               'content' => array('width' => 100,
                                                                                                  'show' => false,
                                                                                                  'name' => 'content'),
                                                                               'meta2' => array('width' => 100,
                                                                                                'show' => false,
                                                                                                'name' => 'meta2'),
                                                                               'meta3' => array('width' => 100,
                                                                                                'show' => false,
                                                                                                'name' => 'meta3'),
                                                                               'custom1' => array('width' => 100,
                                                                                                  'show' => false,
                                                                                                  'name' => 'custom1'),
                                                                               'custom2' => array('width' => 100,
                                                                                                  'show' => false,
                                                                                                  'name' => 'custom2'),
                                                                               'custom3' => array('width' => 100,
                                                                                                  'show' => false,
                                                                                                  'name' => 'custom1'))),
                                                'hint' => array('title' => __('Post layout', 'pzarchitect'),
                                          ...
                                          array('title' => __('Feature location', 'pzarchitect'),
                                                'id' => $prefix . 'feature-location',
                                                'width' => '100%',
                                                'type' => 'button_set',
                                                'default' => 'components',
                                                'required' => array($prefix . 'components-to-show',
                                                                    'contains',
                                                                    'image'),
                                                'subtitle' => 'Use Background when you need the image to fill the post layout.',
                                                'options' => array('components' => __('In Components Group', 'pzarchitect'),
                                                ...
                                                'hint' => array('title' => __('Feature location', 'pzarchitect'),
                                                                'content' => __('Select where within the post layout you want to display the Feature.', 'pzarchitect'))),
                                          array('title' => __('Feature align', 'pzarchitect'),
                                                'id' => $prefix . 'feature-float',
                                                'type' => 'button_set',
                                                'default' => 'default',
                                                'required' => array(array($prefix . 'components-to-show',
                                                                          'contains',
                                                                          'image'),
                                                                    array($prefix . 'feature-location',
                                                                          '=',
                                                                          'components'),),
                                                'subtitle' => __('Float the feature left or right to help close gaps between images and other components.', 'pzarchitect'),
                                                'options' => array('default' => __('Default', 'pzarchitect'),
                                                                   'left' => __('Left', 'pzarchitect'),
                                                                   'right' => __('Right', 'pzarchitect'),),),
                                          array('title' => __('Alternate features position', 'pzarchitect'),
                                                'id' => $prefix . 'alternate-feature-position',
                                                'type' => 'button_set',
                                                'default' => 'off',
                                                'required' => array(array($prefix . 'feature-location',
                                                                          '!=',
                                                                          'fill'),
                                                                    array($prefix . 'feature-location',
                                                                          '!=',
                                                                          'components'),
                                                                    array($prefix . 'components-position',
                                                                          '!=',
                                                                          'top'),
                                                                    array($prefix . 'components-position',
                                                                          '!=',
                                                ...
                                                'options' => array('off' => __('No', 'pzarchitect'),
                                                                   'on' => __('Yes', 'pzarchitect'),),
                                                'hint' => array('title' => __('Alternate features position', 'pzarchitect'),
                                                                'content' => __('Alternate the features position left/right for each post.', 'pzarchitect')),),
                                          array('title' => __('Feature in', 'pzarchitect'),
                                                ...
                                                'options' => array('excerpt' => __('Excerpt', 'pzarchitect'),
                                                                   'content' => __('Body', 'pzarchitect'),),
                                                'hint' => array('title' => __('Feature in', 'pzarchitect'),
                                          ...
                                          array('title' => __('Components area position', 'pzarchitect'),
                                                ...
                                                'options' => array('top' => __('Top', 'pzarchitect'),
                                                                   ...
                                                                   'left' => __('Left', 'pzarchitect'),
                                                                   'right' => __('Right', 'pzarchitect'),),
                                                'hint' => array('title' => __('Components area position', 'pzarchitect'),
                                          ...
                                          array('title' => __('Components area width %', 'pzarchitect'),
                                          ...
                                          array('title' => __('Nudge components area up/down %', 'pzarchitect'),
                                                ...
                                                'step' => 1,
                                                'class' => ' percent',
                                                'required' => array($prefix . 'feature-location',
                                                                    '=',
                                                                    'fill'),
                                                'display_value' => 'label',
                                                'hint' => array('title' => __('Nudge components are up/down', 'pzarchitect'),
                                          ...
                                          array('title' => __('Nudge components area left/right %', 'pzarchitect'),
                                                ...
                                                'required' => array($prefix . 'feature-location',
                                                                    ...
                                                                    'fill'),
                                                'display_value' => 'label',
                                                'hint' => array('title' => __('Nudge components are left/right', 'pzarchitect'),
                                          ...
                                          array('title' => __('Feature as thumbnail width %', 'pzarchitect'),
                                          ...
                                          array('title' => __('Link whole panel', 'pzarchitect'),
    ...
    if (!empty($_architect_options['architect_enable_styling'])) {
      ...
      $sections[] = array('title' => __('Content Panels Styling', 'pzarchitect'),
                          'show_title' => false,
                          'icon_class' => 'icon-large',
                          'icon' => 'el-icon-brush',
                          'fields' => pzarc_fields(//                array(
...
//                    'default'  => 'none'
//                ),
                              array('title' => __('Panels', 'pzarchitect'),
                                    'id' => $prefix . 'panels-section',
                                    'type' => 'section',
                                    'indent' => true,
                                    'class' => 'heading',
                                    'subtitle' => 'Class: .pzarc-panel',
                                    'hint' => array('content' => 'Class: .pzarc-panel'),), pzarc_redux_bg($prefix . 'panels' . $background, '', $defaults[$optprefix . 'panels' . $background]), pzarc_redux_padding($prefix . 'panels' . $padding, '', $defaults[$optprefix . 'panels' . $padding]), pzarc_redux_borders($prefix . 'panels' . $border, '', $defaults[$optprefix . 'panels' . $border]), array('title' => __('Components group', 'pzarchitect'),
                                                                                                                                                                                                                                                                                                                                                                                                               'id' => $prefix . 'components-section',
                                                                                                                                                                                                                                                                                                                                                                                                               'type' => 'section',
                                                                                                                                                                                                                                                                                                                                                                                                               'indent' => true,
                                                                                                                                                                                                                                                                                                                                                                                                               'class' => 'heading',
                                                                                                                                                                                                                                                                                                                                                                                                               'hint' => array('content' => 'Class: .pzarc_components'),
                                                                                                                                                                                                                                                                                                                                                                                                               'subtitle' => 'Class: .pzarc_components',), pzarc_redux_bg($prefix . 'components' . $background, array('.pzarc_components'), $defaults[$optprefix . 'components' . $background]), pzarc_redux_padding($prefix . 'components' . $padding, array('.pzarc_components'), $defaults[$optprefix . 'components' . $padding]), pzarc_redux_borders($prefix . 'components' . $border, array('.pzarc_components'), $defaults[$optprefix . 'components' . $border]), array('title' => __('Entry', 'pzarchitect'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'id' => $prefix . 'hentry-section',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'type' => 'section',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'indent' => true,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'class' => 'heading',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'hint' => array('content' => 'Class: .hentry'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'subtitle' => !$this->defaults ? (is_array($_architect['architect_config_hentry-selectors']) ? 'Classes: ' . implode(', ', $_architect['architect_config_hentry-selectors']) : 'Class: ' . $_architect['architect_config_hentry-selectors']) : ''), // id,selectors,defaults
      ...
      $sections[] = array('id' => 'custom-css',
                          'title' => __('Custom CSS', 'pzarchitect'),
                          'icon_class' => 'icon-large',
                          'icon' => 'el-icon-wrench',
                          'fields' => array(array('id' => $prefix . 'custom-css',
                                                  'type' => 'ace_editor',
                                                  'title' => __('Custom CSS', 'pzarchitect'),
                                                  'mode' => 'css',
                                                  'options' => array('minLines' => 25),
    ...
    $metaboxes[] = array('id' => 'panels-design',
  ...
  function pzarc_mb_titles_settings($metaboxes, $defaults_only = false)
  {
    ...
    $sections   = array();
    $sections[] = array('title' => 'Titles settings',
                        'show_title' => false,
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-adjust-alt',
                        'fields' => array(array('title' => __('Title prefix', 'pzarchitect'),
                                          ...
                                          array('id' => $prefix . 'title-margins',
                                                ...
                                                'left' => true,
                                                'right' => true,
                                                'required' => array('_panels_design_title-prefix',
                                                                    '!=',
                                                                    'none'),),
                                          array('title' => __('Title thumbnail width', 'pzarchitect'),
                                          ...
                                          array('title' => __('Prefix separator', 'pzarchitect'),
                                                'id' => $prefix . 'title-bullet-separator',
                                                'type' => 'text',
                                                'class' => 'textbox-small',
                                                'default' => '. ',
                                                'required' => array(array('_panels_design_title-prefix',
                                                                          '!=',
                                                                          'none'),
                                                                    array('_panels_design_title-prefix',
                                                                          '!=',
                                                                          'disc'),
                                                                    array('_panels_design_title-prefix',
                                                                          '!=',
                                                                    ...
                                                                    array('_panels_design_title-prefix',
                                                                          '!=',
                                                                          'thumb'))),
                                          array('title' => __('Link titles', 'pzarchitect'),
                                          ...
                                          array('title' => __('Use Headway/Blox alternate titles', 'pzarchitect'),
                                          ...
                                          array('title' => __('Wrapper tag', 'pzarchitect'),
    ...
    $sections[] = array('title' => __('Responsive overrides', 'pzarchitect'),
                        'show_title' => false,
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-screen',
                        'fields' => array(

                            array('title' => __('Use responsive font sizes', 'pzarchitect'),
                                  'id' => $prefix . 'use-responsive-font-size-title',
                                  'type' => 'switch',
                                  'default' => false,
                                  //'required' => array('show_advanced', 'equals', true),
                                  'subtitle' => __('Enabling this will override all other CSS title sizing', 'pzarchitect')),
                            array('title' => __('Fluid fonts', 'pzarchitect'),
                                  'id' => $prefix . 'use-scale-fonts-title',
                                  'type' => 'switch',
                                  'default' => true,
                                  'required' => array($prefix . 'use-responsive-font-size-title',
                                                      'equals',
                                                      true),
                            ...
                            array('id' => $prefix . 'title-font-size-bp1',
                            ...
                            array('id' => $prefix . 'title-font-size-bp2',
                                  'title' => __('Font size - medium screen ', 'pzarchitect'),
                                  'subtitle' => $_architect_options['architect_breakpoint_2']['width'] . ' to ' . $_architect_options['architect_breakpoint_1']['width'],
                                  'required' => array(array($prefix . 'use-responsive-font-size-title',
                                                            'equals',
                                                            true),
                                                      array($prefix . 'use-scale-fonts-title',
                                                            'equals',
                                                            false)),
                                  'type' => 'typography',
                                  ...
                                  'word-spacing' => false,
                                  'letter-spacing' => false,),
                            array('id' => $prefix . 'title-font-size-bp3',
                                  ...
                                  'word-spacing' => false,
                                  'letter-spacing' => false,),
                            array('id' => $prefix . 'title-font-scale-upper-bp',
                                  ...
                                  'required' => array(array($prefix . 'use-responsive-font-size-title',
                                                      ...
                                                      array($prefix . 'use-scale-fonts-title',
                                                            'equals',
                                                            true)),),
                            array('id' => $prefix . 'title-font-scale-lower-bp',
    ...
    if (!empty($_architect_options['architect_enable_styling'])) {
      ...
      $sections[] = array('title' => __('Titles styling', 'pzarchitect'),
                          'show_title' => false,
                          'icon_class' => 'icon-large',
                          'icon' => 'el-icon-brush',
    ...
    $metaboxes[] = array('id' => 'titles-settings',
  ...
  function pzarc_mb_meta_settings($metaboxes, $defaults_only = false)
  {
    ...
    $prefix   = '_panels_design_';
    // Settings
    $sections[] = array('title' => __('Meta settings', 'pzarchitect'),
                        'show_title' => false,
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-adjust-alt',
                        ...
                        'fields' => array(// ======================================
                                          ...
                                          array('title' => __('Excluded authors', 'pzarchitect'),
                                          ...
                                          array('title' => __('Author avatar', 'pzarchitect'),
                                                'id' => $prefix . 'avatar',
                                                'type' => 'button_set',
                                                'default' => 'none',
                                                'options' => array('none' => __('None', 'pzarchitect'),
                                          ...
                                          array('title' => __('Avatar size', 'pzarchitect'),
  ...
  function pzarc_mb_features_settings($metaboxes, $defaults_only = false)
  {
    ...
    $prefix   = '_panels_design_';
    // Settings
    $sections[] = array('title' => 'Feature settings',
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-adjust-alt',
                        ...
                        'fields' => array(array('title' => __('Feature type', 'pzarchitect'),
                                                'id' => '_panels_settings_feature-type',
                                                'type' => 'button_set',
                                                'default' => 'image',
                                                'options' => array('image' => __('Images', 'pzarchitect'),
                                                                   'video' => __('Videos', 'pzarchitect')),
                                                'subtitle' => __('Choose whether Feature is images or videos.', 'pzarchitect'),
                                                'required' => array($prefix . 'components-to-show',
                                                                    'contains',
                                                                    'image'),),
                                          array('title' => __('Image cropping', 'pzarchitect'),
                                                'id' => '_panels_settings_image-focal-point',
                                                'type' => 'select',
                                                'default' => 'respect',
                                                'select2' => array('allowClear' => false),
                                                'required' => array('_panels_settings_feature-type',
                                                                    '=',
                                                                    'image'),
                                                'options' => array('respect' => __('Use focal point', 'pzarchitect'),
                                          ...
                                          array('title' => __('Use embedded images', 'pzarchitect'),
                                                ...
                                                'required' => array(//array('show_advanced', 'equals', true),
                                                                    array('_panels_settings_feature-type',
                                                                          '=',
                                                                          'image'),),
                                          ...
                                          //            )
                                          //          ),
                                          array('title' => __('Filler image', 'pzarchitect'),
                                                ...
                                                'required' => array(array('_panels_settings_feature-type',
                                                                          '=',
                                                                          'image'),),),
                                          array('id' => $prefix . 'use-filler-image-source-specific',
                                                'type' => 'media',
                                                ...
                                                'required' => array($prefix . 'use-filler-image-source',
                                                                    '=',
                                                                    'specific'),
                                                'library_filter' => array('jpg',
                                                                          'jpeg',
                                                                          'png')),
                                          array('id' => $prefix . 'image-max-dimensions',
                                          ...
                                          //          ),
                                          array('title' => __('Background images effect on screen resize', 'pzarchitect'),
                                                ...
                                                'options' => array('scale' => __('Scale', 'pzarchitect'),
                                                ...
                                                'required' => array(//array('show_advanced', 'equals', true),
                                                                    array('_panels_settings_feature-type',
                                                                          '=',
                                                                          'image'),
                                                                    array('_panels_design_feature-location',
                                                                          '=',
                                                                          'fill'),),
                                                'default' => 'scale',),
                                          array('id' => $prefix . 'image-spacing',
                                                'type' => 'spacing',
                                                'mode' => 'margin',
                                                'units' => '%',
                                                'units_extended' => 'false',
                                                ...
                                                'default' => array('margin-top' => '0',
                                                                   ...
                                                                   'margin-left' => '0',
                                                                   'units' => '%',)),
                                          array('title' => __('Link to', 'pzarchitect'),
                                          ...
                                          array('title' => __('Specific URL tooltip', 'pzarchitect'),
                                          ...
                                          array('title' => __('Image Captions', 'pzarchitect'),
                                                ...
                                                'required' => array('_panels_settings_feature-type',
                                                                    '=',
                                                                    'image'),),
                                          array('title' => __('Centre feature', 'pzarchitect'),
    ...
    if (!empty($_architect_options['architect_enable_styling'])) {
      ...
      $sections[] = array('title' => __('Feature styling', 'pzarchitect'),
                          'show_title' => false,
                          'icon_class' => 'icon-large',
                          'icon' => 'el-icon-brush',
                          'fields' => pzarc_fields(array('title' => __('Image', 'pzarchitect'),
                          ...
                          ), array('title' => __('Background', 'pzarchitect'),
                                   ...
                                   'default' => $defaults[$optprefix . 'entry-image' . $background]), array('title' => __('Border', 'pzarchitect'),
                                                                                                            'id' => $prefix . 'entry-image' . $border,
                                                                                                            'type' => 'border',
                                                                                                            'all' => false,
                                                                                                            'output' => array('.pzarc_entry_featured_image'),
                                                                                                            'default' => $defaults[$optprefix . 'entry-image' . $border]), array('title' => __('Padding', 'pzarchitect'),
                                                                                                                                                                                 'id' => $prefix . 'entry-image' . $padding,
                                                                                                                                                                                 'mode' => 'padding',
                                                                                                                                                                                 'type' => 'spacing',
                                                                                                                                                                                 'units' => array('px',
                                                                                                                                                                                                  '%'),
                                                                                                                                                                                 'default' => $defaults[$optprefix . 'entry-image' . $padding]), array('title' => __('Margin', 'pzarchitect'),
  ...
  function pzarc_mb_body_settings($metaboxes, $defaults_only = false)
  {
    ...
    // Settings
    $sections[] = array('title' => __('Body/excerpt settings', 'pzarchitect'),
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-adjust-alt',
                        'fields' => array(array('title' => __('Maximize body', 'pzarchitect'),
                                          ...
                                          array('title' => __('Action on more click', 'pzarchitect'),
                                                'id' => $prefix . 'more-click-action',
                                                'type' => 'button_set',
                                                'options' => array('none' => __('Default', 'pzarchitect'),
                                          ...
                                          array('id' => $prefix . 'excerpt-heading',
                                                'title' => __('Excerpts', 'pzarchitect'),
                                                'type' => 'section',
                                                'indent' => true,
                                                'class' => 'heading',),
                                          array('title' => __('Display entered excerpts only', 'pzarchitect'),
                                          ...
                                          array('id' => $prefix . 'excerpts-word-count',
                                                ...
                                                'required' => array($prefix . 'manual-excerpts',
                                                                    '=',
                                                                    false)),
                                          array('title' => __('Truncation indicator', 'pzarchitect'),
                                                ...
                                                'required' => array($prefix . 'manual-excerpts',
                                                                    '=',
                                                                    false)),
                                          array('title' => __('Read More', 'pzarchitect'),
    ...
    $sections[] = array('title' => __('Responsive overrides', 'pzarchitect'),
                        ...
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-screen',
                        'fields' => array(array('id' => $prefix . 'responsive-hide-content',
                                          ...
                                          array('title' => __('Fluid fonts', 'pzarchitect'),
                                                ...
                                                'type' => 'switch',
                                                'default' => true,
                                                'required' => array($prefix . 'use-responsive-font-size',
                                                                    'equals',
                                                                    true),
                                                'subtitle' => __('This makes the fonts scale in size from one breakpoint to the next, rather than suddenly changing at each breakpoint.', 'pzarchitect')),
                                          array('id' => $prefix . 'content-font-size-bp1',
                                                'title' => __('Maximum font size - large screen ', 'pzarchitect'),
                                                'subtitle' => $_architect_options['architect_breakpoint_1']['width'] . __(' and above', 'pzarchitect'),
                                                'required' => array($prefix . 'use-responsive-font-size',
                                                                    'equals',
                                                ...
                                                'word-spacing' => false,
                                                'letter-spacing' => false,),
                                          array('id' => $prefix . 'content-font-size-bp2',
                                                'title' => __('Font size - medium screen ', 'pzarchitect'),
                                                'subtitle' => $_architect_options['architect_breakpoint_2']['width'] . ' to ' . $_architect_options['architect_breakpoint_1']['width'],
                                                'required' => array(array($prefix . 'use-responsive-font-size',
                                                                          'equals',
                                                                          true),
                                                                    array($prefix . 'use-scale-fonts',
                                                                          'equals',
                                                                          false)),
                                                'type' => 'typography',
                                                ...
                                                'word-spacing' => false,
                                                'letter-spacing' => false,),
                                          array('id' => $prefix . 'content-font-size-bp3',
                                                'title' => __('Minimum font size - small screen ', 'pzarchitect'),
                                                'subtitle' => $_architect_options['architect_breakpoint_2']['width'] . ' and below',
                                                'required' => array($prefix . 'use-responsive-font-size',
                                                                    'equals',
                                                ...
                                                'word-spacing' => false,
                                                'letter-spacing' => false,),
                                          array('id' => $prefix . 'content-font-scale-upper-bp',
                                                'title' => __('Override large screen breakpoint', 'pzarchitect'),
                                                'type' => 'text',
                                                'default' => 1280,
                                                'subtitle' => __('Above this window width, no scaling will be done.'),
                                                'required' => array(array($prefix . 'use-responsive-font-size',
                                                                    ...
                                                                    array($prefix . 'use-scale-fonts',
                                                                          'equals',
                                                                          true)),),
                                          array('id' => $prefix . 'content-font-scale-lower-bp',
                                                'title' => __('Override small screen breakpoint', 'pzarchitect'),
                                                'type' => 'text',
                                                'default' => 360,
                                                'subtitle' => __('Below this window width, no scaling will be done.'),
    ...
    if (!empty($_architect_options['architect_enable_styling'])) {
      ...
      $sections[] = array('title' => __('Body content styling', 'pzarchitect'),
                          'show_title' => false,
                          'icon_class' => 'icon-large',
                          'icon' => 'el-icon-brush',
      ...
      $sections[] = array('title' => __('Excerpts styling', 'pzarchitect'),
                          ...
                          'fields' => pzarc_fields(array('title' => __('Excerpt', 'pzarchitect'),
                                                         'id' => $prefix . 'entry-excerpt',
                                                         'type' => 'section',
                                                         'indent' => true,
                                                         'class' => 'heading',), pzarc_redux_font($prefix . 'entry-excerpt' . $font, array('.entry-excerpt'), $defaults[$optprefix . 'entry-excerpt' . $font]), pzarc_redux_bg($prefix . 'entry-excerpt' . $font . $background, array('.entry-excerpt'), $defaults[$optprefix . 'entry-excerpt' . $font . $background]), pzarc_redux_padding($prefix . 'entry-excerpt' . $font . $padding, array('.entry-excerpt'), $defaults[$optprefix . 'entry-excerpt' . $font . $padding]), pzarc_redux_margin($prefix . 'entry-excerpt' . $font . $margin, array('.entry-excerpt'), $defaults[$optprefix . 'entry-excerpt' . $font . $margin], 'tb'), pzarc_redux_borders($prefix . 'entry-excerpt' . $border, array('.entry-excerpt'), $defaults[$optprefix . 'entry-excerpt' . $border]), pzarc_redux_links($prefix . 'entry-excerpt' . $font . $link, array('.entry-excerpt a'), $defaults[$optprefix . 'entry-excerpt' . $font . $link]), array('title' => __('Excerpt paragraphs', 'pzarc'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          'id' => $prefix . 'entry-excerptp',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          'desc' => 'Class: .entry-excerpt p',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          'type' => 'section',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          'indent' => true,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          'class' => 'heading',), pzarc_redux_font($prefix . 'entry-excerptp' . $font, array('.entry-excerpt p'), $defaults[$optprefix . 'entry-excerptp' . $font]), pzarc_redux_padding($prefix . 'entry-excerptp' . $font . $padding, array('.entry-excerpt p'), $defaults[$optprefix . 'entry-excerptp' . $font . $padding]), pzarc_redux_margin($prefix . 'entry-excerptp' . $font . $margin, array('.entry-excerpt p'), $defaults[$optprefix . 'entry-excerptp' . $font . $margin]), array('title' => __('Read more', 'pzarchitect'),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'id' => $prefix . 'entry-readmore',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'type' => 'section',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'indent' => true,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'class' => 'heading',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'hint' => array('content' => 'Class: a.pzarc_readmore'),), pzarc_redux_font($prefix . 'entry-readmore' . $font, array('.readmore'), $defaults[$optprefix . 'entry-readmore' . $font]), pzarc_redux_bg($prefix . 'entry-readmore' . $font . $background, array('.readmore'), $defaults[$optprefix . 'entry-readmore' . $font . $background]), pzarc_redux_padding($prefix . 'entry-readmore' . $font . $padding, array('.readmore'), $defaults[$optprefix . 'entry-readmore' . $font . $padding]), pzarc_redux_links($prefix . 'entry-readmore' . $font . $link, array('a.readmore'), $defaults[$optprefix . 'entry-readmore' . $font . $link])));
    }
    $metaboxes[] = array('id' => 'body-settings',
  ...
  function pzarc_mb_customfields_settings($metaboxes, $defaults_only = false)
  {
     ...
     */
    $sections[] = array('title' => __('Custom fields general settings', 'pzarchitect'),
                        'show_title' => false,
                        'icon_class' => 'icon-large',
                        'icon' => 'el-icon-adjust-alt',
                        'fields' => array(array('title' => __('Number of custom fields', 'pzarchitect'),
                                                ...
                                                'hint' => array('title' => __('Number of custom fields', 'pzarchitect'),
          ...
          $sections[] = array('title' => $cfname . ' settings',
                              ...
                              'fields' => array(array('title' => __('Show in custom field group', 'pzarchitect'),
                                                      ...
                                                      'options' => array('custom1' => __('Custom 1', 'pzarchitect'),
                                                                         'custom2' => __('Custom 2', 'pzarchitect'),
                                                                         'custom3' => __('Custom 3', 'pzarchitect'))),
                                                array('title' => __('Field name', 'pzarchitect'),
                                                ...
                                                array('title' => __('Field type', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-field-type',
                                                      'type' => 'button_set',
                                                      'default' => 'text',
                                                      'options' => array('text' => __('Text', 'pzarchitect'),
                                                                         ...
                                                                         'group' => __('Group', 'pzarchitect')
                                                                         //'acf-repeater' => _('ACF Repeater'pzarchitect),
                                                      )

                                                ),
                                                array('id' => $prefix . 'cfield-' . $i . '-date-format',
                                                      'title' => __('Date format', 'pzarchitect'),
                                                      'type' => 'text',
                                                      'default' => 'l, F j, Y g:i a',
                                                      ...
                                                      'required' => array($prefix . 'cfield-' . $i . '-field-type',
                                                                          '=',
                                                                          'date'),),
                                                array('id' => $prefix . 'cfield-' . $i . '-number-decimals',
                                                      ...
                                                      'required' => array($prefix . 'cfield-' . $i . '-field-type',
                                                                          '=',
                                                                          'number'),),
                                                array('id' => $prefix . 'cfield-' . $i . '-number-decimal-char',
                                                      ...
                                                      'required' => array($prefix . 'cfield-' . $i . '-field-type',
                                                                          '=',
                                                                          'number'),),
                                                array('id' => $prefix . 'cfield-' . $i . '-number-thousands-separator',
                                                ...
                                                array('title' => __('Shortcodes in text fields', 'pzarchitect'),
                                                ...
                                                //                'type'  => 'text',
                                                //              ),
                                                array('title' => __('Link field', 'pzarchitect'),
                                                ...
                                                array('title' => __('Open link in', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-link-behaviour',
                                                      'type' => 'button_set',
                                                      'default' => '_self',
                                                      'options' => array('_self' => __('Same tab', 'pzarchitect'),
                                                                         '_blank' => __('New tab', 'pzarchitect')),),
                                                array('title' => __('Prefix text', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-prefix-text',
                                                      'type' => 'text',
                                                      'default' => '',),
                                                array('title' => __('Prefix image', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-prefix-image',
                                                      'type' => 'media',
                                                      'default' => '',),
                                                array('title' => __('Suffix text', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-suffix-text',
                                                      'type' => 'text',
                                                      'default' => '',),
                                                array('title' => __('Suffix image', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-suffix-image',
                                                      'type' => 'media',
                                                      'default' => '',),
                                                array('title' => __('Prefix/suffix images width', 'pzarchitect'),
                                                      'id' => $prefix . 'cfield-' . $i . '-ps-images-width',
                                                      'type' => 'dimensions',
                                                      'height' => false,
                                                      'default' => array('width' => '32px'),
                                                      'units' => 'px'),
                                                array('title' => __('Prefix/suffix images height', 'pzarchitect'),
    ...
    if (!empty($_architect_options['architect_enable_styling'])) {
      ...
      if (!empty($_GET['post'])) {
        ...
        for ($i = 1; $i <= $cfcount; $i++) {
          $cfname     = 'Custom field ' . $i . (!empty($this->postmeta['_panels_design_cfield-' . $i . '-name'][0]) ? ': <br>' . $this->postmeta['_panels_design_cfield-' . $i . '-name'][0] : '');
          $sections[] = array('title' => $cfname . ' styling',
                              'show_title' => false,
                              'icon_class' => 'icon-large',
                              'icon' => 'el-icon-brush',
    ...
    $metaboxes[] = array('id' => 'customfields-settings',
