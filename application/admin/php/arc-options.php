...
//      }
    ...
    public function __construct()
    {
      ...
      // Function to test the compiler hook and demo CSS output.
      add_filter('redux/options/' . $this->args['opt_name'] . '/compiler', array($this,
                                                                                 'compiler_action'), 10, 2);
      // Above 10 is a priority, but 2 in necessary to include the dynamically generated CSS to be sent to the function.
...
//      }
    ...
    public function setSections()
    {
        ...
        if ($sample_patterns_dir = opendir($sample_patterns_path)) :
          ...
          while (($sample_patterns_file = readdir($sample_patterns_dir)) !== false) {
            ...
            if (stristr($sample_patterns_file, '.png') !== false || stristr($sample_patterns_file, '.jpg') !== false) {
              ...
              $sample_patterns[] = array('alt' => $name,
      ...
      $customize_title = sprintf(__('Customize &#8220;%s&#8221;', 'pzarchitect'), $this->theme->display('Name'));
      ...
      <div id="current-theme" class="<?php echo esc_attr($class); ?>">
        ...
        <div>
          ...
          <?php if ($this->theme->parent()) {
            printf(' <p class="howto">' . __('This <a href="%1$s">child theme</a> requires its parent theme, %2$s.') . '</p>', __('http://codex.wordpress.org/Child_Themes', 'pzarchitect'), $this->theme->parent()->display('Name'));
          } ?>
      ...
      $this->sections[_amb_options_general]    = array('title' => __('General ', 'pzarchitect'),
                                             ...
                                             'fields' => array(array('title' => __('Styling', 'pzarchitect'),
                                                                     ...
                                                                     'type' => 'section',
                                                                     'indent' => true,),
                                                               array('title' => __('Use Architect styling', 'pzarchitect'),
                                                               ...
                                                               array('title' => __('Typography units', 'pzarchitect'),
                                                                     ...
                                                                     'options' => array('px' => 'px',
                                                                                        ...
                                                                                        'rem' => 'rem',),
                                                                     'default' => 'px'),
                                                               array('title' => __('Focal point default', 'pzarchitect'),
                                                                     'id' => 'architect_focal_point_default',
                                                                     'subtitle'=>__('X,Y co-ordinates to use if image has no focal point set.','pzarchitect'),
                                                                     'type' => 'text',
                                                                     'default' => '50,10'),
                                                               (($is_hw || $is_blox) ? array('title' => __('Add Headway/Blox Content Block class', 'pzarchitect'),
                                                               ...
                                                               (($is_hw || $is_blox) ? array('title' => __('Use Architect Headway/Blox CSS from Design Mode', 'pzarchitect'),
                                                                                             'id' => 'architect_use-hw-css',
                                                                                             'type' => 'switch',
                                                                                             'on' => __('Yes', 'pzarchitect'),
                                                                                             'off' => __('No', 'pzarchitect'),
                                                                                             'default' => ($is_hw || $is_blox),
                                                               ...
                                                               array('id' => 'architect_stylings_end-section',
                                                                     'type' => 'section',
                                                                     'indent' => false,),
                                                               array('title' => __('Appearance', 'pzarchitect'),
                                                                     'id' => 'architect_appearance_section',
                                                                     'type' => 'section',
                                                                     'indent' => true,),
                                                               array('title' => __('Hide page guides and tutorials', 'pzarchitect'),
                                                                     ...
                                                                     'on' => __('Yes', 'pzarchitect'),
                                                                     'off' => __('No', 'pzarchitect')),
                                                               array('title' => __('Enable admin background image', 'pzarchitect'),
...
//                                                                                        'mixed-hopes' => __('Mixed Hopes', 'pzarchitect'),
                                                               ...
                                                               array('id' => 'architect_appearance_end-section',
                                                                     'type' => 'section',
                                                                     'indent' => false,),
                                                               array('title' => __('Shortcodes', 'pzarchitect'),
                                                                     'id' => 'architect_shortcodes_section',
                                                                     'type' => 'section',
                                                                     'indent' => true,),
                                                               array('title' => __('Default shortcode blueprint', 'pzarchitect'),
                                                               ...
                                                               array('title' => __('Replace WP Galleries with Blueprint', 'pzarchitect'),
                                                               ...
                                                               array('id' => 'architect_shortcodes_end-section',
                                                                     'type' => 'section',
                                                                     'indent' => false,),
                                                               array('title' => __('Enhancements', 'pzarchitect'),
                                                               ...
                                                               //
                                                               //            ),
//                                                               array('title' => __('Activate Architect Builder on Pages editor', 'pzarchitect'),
...
//                                                               ),
                                                               apply_filters('arc-show-content-types',array('title' => __('Additional content types', 'pzarchitect'),
                                                                     ...
                                                                     'type' => 'checkbox',
                                                                                                            'multi'=>true,
                                                                     'options' => array('pz_snippets' => __('Snippets', 'pzarchitect'),
                                                                                        'pz_testimonials' => __('Testimonials', 'pzarchitect'),
                                                                                        'pz_showcases' => __('Showcases', 'pzarchitect')),
                                                                     'default' => array('pz_testimonials' => 0,
                                                                                        'pz_snippets' => 1,
                                                                                        'pz_showcases' => 0))
                                                               ),
                                                               array('title' => __('Featured Video field', 'pzarchitect'),
                                                                     ...
                                                                     'default' => array('post' => 0,
                                                                                        'page' => 0,
                                                                                        'pz_snippets' => 1)
                                                               ),
                                                               array('title' => __('Exclude Snippets from search results', 'pzarchitect'),
                                                                     'id' => 'architect_exclude-snippets-search',
                                                                     'type' => 'switch',
                                                                     'default' => false,
                                                                     'off' => __('No', 'pzarchitect'),
                                                                     'on' => __('Yes', 'pzarchitect'),
                                                               ...
                                                               //              'default'  => true
                                                               //            ),
                                                               array('id' => 'architect_mods_end-section',
                                                                     'type' => 'section',
                                                                     'indent' => false,),
                                                               array('title' => __('Other', 'pzarchitect'),
                                                                     'id' => 'architect_other_section',
                                                                     'type' => 'section',
                                                                     'indent' => true),
                                                               array('title' => __('Exclude hidden custom fields', 'pzarchitect'),
                                                                     ...
                                                                     'on' => __('Yes', 'pzarchitect'),
                                                                     'off' => __('No', 'pzarchitect')),
                                                               array('title' => __('Turn off dropdowns of post lists', 'pzarchitect'),
                                                               ...
                                                               //              'off'      => __( 'No', 'pzarchitect' )
                                                               //            ),
                                                               array('title' => __('Enable beta features', 'pzarchitect'),
                                                                     ...
                                                                     'on' => __('Yes', 'pzarchitect'),
                                                                     'off' => __('No', 'pzarchitect')),
                                                               array('title' => __('Beta features', 'pzarchitect'),
                                                                     'id' => 'architect_beta_features',
                                                                     'type' => 'info',
                                                                     'required' => array('architect_enable_beta',
                                                                                         'equals',
                                                                                         true),
      ...
      $this->sections[_amb_options_responsive] = array('title' => 'Responsive ',
                                             ...
                                             'fields' => array(array('title' => __('Breakpoints', 'pzarchitect'),
                                                                     'id' => 'architect_breakpoint_section',
                                                                     'type' => 'section',
                                                                     'indent' => true,),
                                                               array('title' => __('Wide screen breakpoint', 'pzarchitect'),
                                                                     'subtitle'=>__('Screens larger than this size','pzarchitect'),
                                                                     'id' => 'architect_breakpoint_1',
                                                                     'type' => 'dimensions',
                                                                     'height' => false,
                                                                     'units' => 'px',
                                                                     'default' => array('width' => '960'),),
                                                               array('title' => __('Medium screen breakpoint', 'pzarchitect'),
                                                                     'subtitle'=>__('Screens larger than this size','pzarchitect'),
                                                               ...
                                                               array('id' => 'architect_responsive-end-section',
                                                                     'type' => 'section',
                                                                     'indent' => false,),
                                                               //            array(
                                                               ...
                                                               array('title' => __('Images', 'pzarchitect'),
                                                                     'id' => 'architect_responsive-images_section',
                                                                     'type' => 'section',
                                                                     'indent' => true,),
                                                               array('title' => __('Create and use retina images', 'pzarchitect'),
      ...
      $this->sections[_amb_options_rewrites]   = array('title' => __('Rewrites', 'pzarchitect'),
                                             ...
                                             'fields' => array(array('title' => __('Snippets', 'pzarchitect'),
                                                               ...
                                                               array('title' => __('Testimonials', 'pzarchitect'),
...
//                                                               array('title' => __('Archtiect Galleries', 'pzarchitect'),
//                                                                     'id' => 'architect_rewrites-arcgallery',
//                                                                     'type' => 'text',
//                                                                     'validate' => 'no_special_chars',
//                                                                     'default' => 'pz_arcgallery',
//                                                                     'subtitle' => __('Set what name appears in the URL for Architect Galleries', 'pzarchitect'),),
                                                               array('title' => __('Showcases', 'pzarchitect'),
      ...
      $this->sections[_amb_options_language]   = array('title' => 'Language ',
                                             ...
                                             'fields' => array(array('title' => __('Categories archive pages title', 'pzarchitect'),
                                                               ...
                                                               array('title' => __('Tags archive pages title', 'pzarchitect'),
                                                               ...
                                                               array('title' => __('Months archive pages title', 'pzarchitect'),
                                                               ...
                                                               array('title' => __('Custom taxonomies archive pages title', 'pzarchitect'),
...
//        );
    ...
    public function setHelpTabs()
    {
      ...
      $this->args['help_tabs'][] = array('id' => 'redux-opts-1',
                                         'title' => __('Theme Information 1', 'pzarchitect'),
                                         'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'pzarchitect'));

      $this->args['help_tabs'][] = array('id' => 'redux-opts-2',
                                         'title' => __('Theme Information 2', 'pzarchitect'),
                                         'content' => __('<p>This is the tab content, HTML is allowed.</p>', 'pzarchitect'));

      // Set the help sidebar
      $this->args['help_sidebar'] = __('<p>This is the sidebar content, HTML is allowed.</p>', 'pzarchitect');
    ...
    public function setArguments()
    {
      ...
      $this->args = array(
        ...
        'help_tabs' => array(),
        'help_sidebar' => '',
        'hints' => array('icon' => 'el el-question-sign',
                         'icon_position' => 'right',
                         'icon_color' => 'lightgray',
                         'icon_size' => 'normal',
                         'tip_style' => array('color' => 'yellow',
                                              'shadow' => true,
                                              'rounded' => false,
                                              'style' => '',),
                         'tip_position' => array('my' => 'top right',
                                                 'at' => 'bottom left',),
                         'tip_effect' => array('show' => array('effect' => 'show',
                                                               'duration' => '300',
                                                               'event' => 'mouseover',),
                                               'hide' => array('effect' => 'show',
                                                               'duration' => '300',
      ...
      $this->args['share_icons'][] = array('url' => 'http://twitter.com/pizazzwp',
