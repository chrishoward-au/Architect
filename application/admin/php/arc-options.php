      ...
      public function setSections() {
        ...
        $this->sections[ _amb_options_general ]    = array(
            ...
            'fields'     => array(
                ...
                array(
                    'title'    => __( 'Disable font family in typography sections', 'pzarchitect' ),
                ...
                array(
                    'title'    => __( 'Disable Google fonts in typography sections', 'pzarchitect' ),
                ...
                array(
                    'title'    => __( 'Focal point default', 'pzarchitect' ),
                ...
                ( ( $is_hw || $is_blox || $is_padma ) ? array(
                    'title'    => __( 'Use Architect Headway/Blox/Padma CSS from Design Mode', 'pzarchitect' ),
                    'id'       => 'architect_use-hw-css',
                    'type'     => 'switch',
                    'on'       => __( 'Yes', 'pzarchitect' ),
                    'off'      => __( 'No', 'pzarchitect' ),
                    'default'  => ( $is_hw || $is_blox || $is_padma ),
                    'subtitle' => __( 'Use the stylings you configure for Architect in the Headway/Blox/Padma Visual Editor Design Mode.', 'pzarchitect' ),

                ) : NULL ),
                array(
                    'title'   => __( 'Architect Shortcodes dropdown in post editor', 'pzarchitect' ),
                    'id'      => 'architect_shortcodes-dropdown',
                    'type'    => 'button_set',
                    'options' => array(
                        'both'   => __( 'Admins and Editors', 'pzarchitect' ),
                ...
                array(
                    'title'    => __( 'Choose admin background gradient', 'pzarchitect' ),
                    'id'       => 'architect_bgimage',
                    'type'     => 'button_set',
                    'required' => array(
                        'architect_enable_bgimage',
                        'equals',
                        TRUE,
                    ),
                    'options'  => array(
                ...
                array(
                    'title'   => __( 'Exclude Snippets from search results', 'pzarchitect' ),
        ...
        $this->sections[ _amb_options_responsive ] = array(
            'title'      => 'Responsive ',
            'show_title' => TRUE,
            'icon'       => 'el-icon-laptop',
        ...
        $this->sections[ _amb_options_rewrites ]   = array(
        ...
        $this->sections[ _amb_options_language ]   = array(
            'title'      => 'Language ',
            'show_title' => TRUE,
            'icon'       => 'el-icon-globe',
            'fields'     => array(
