...
<ul>
<li>ADDED: Error msg if Presets selector can&#8217;t read presets files.</li>
<li>FIXED: Removed Features tab as it&#8217;s not populated</li>
<li>FIXED: Changed misleading message saying &#8220;This theme requires Redux&#8221; to &#8220;This plugin requires Redux&#8221;</li>
<li>FIXED: Strip architect shortcodes in excerpts to prevent loops</li>
<li>FIXED: Replaced sections array keys with numeric constants due to PHP 7.1.12 notices</li>
<li>FIXED: Prevent a Blueprint from calling itself when nesting Blueprints</li>
<li>FIXED: Patch for Freemius where sometimes giving cURL error when activating licence</li>
<li>CHANGED: Now using class rather than ID when creating Blueprint CSS since Blueprints can be re-used on the same page. You will need to change any custom CSS that was using the ID.</li>
<li>CHANGED: Blueprint CSS to load as late as possible in head.</li>
<li>CHANGED: Remove custom fields support from free version</li>
</ul>
