<?php
	...
	echo'
        ...
        <p>This release has several small bug fixes</p> 
        <hr>
        <p><strong>Note:</strong> Development of the Architect Gutenberg block has been delayed as the beta status of Gutenberg is causing more problems than anticipated. There is a separate Architect Gutenberg plugin in the meantime, which anyone is welcome to test.</p>
