...
jQuery(document).ready(function () {
  ...
  function pzarc_update_tabs_to_show(et) {
    ...
    jQuery(els).each(function () {
      ...
      switch (tabVal) {
        case 'title':
          tab_status = jQuery('input#_panels_design_components-to-show-buttonsettitle:checked').length === 1;
        ...
        case 'meta2':
        case 'meta3':
          tab_status = jQuery('input#_panels_design_components-to-show-buttonsetmeta1:checked').length === 1 || jQuery('input#_panels_design_components-to-show-buttonsetmeta2:checked').length === 1 || jQuery('input#_panels_design_components-to-show-buttonsetmeta3:checked').length === 1;
        ...
        case 'content':
        case 'excerpt':
          tab_status = jQuery('input#_panels_design_components-to-show-buttonsetcontent:checked').length === 1 || jQuery('input#_panels_design_components-to-show-buttonsetexcerpt:checked').length === 1;
        ...
        case 'image':
          ...
          tab_status = jQuery('input#_panels_design_components-to-show-buttonsetimage:checked').length === 1;
        ...
        case 'custom2':
        case 'custom3':
          tab_status = jQuery('input#_panels_design_components-to-show-buttonsetcustom1:checked').length === 1 || jQuery('input#_panels_design_components-to-show-buttonsetcustom2:checked').length === 1 || jQuery('input#_panels_design_components-to-show-buttonsetcustom3:checked').length === 1;
