...
//      var_dump($data);
  ...
  class arc_Panel_slides_Wrapper extends arc_Panel_slides
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section)
    {
...
//      }
   ...
   */
  class arc_Panel_slides_Title extends arc_Panel_slides
  {
    /**
  ...
  class arc_Panel_slides_Meta extends arc_Panel_slides
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section)
    {
  ...
  class arc_Panel_slides_Image extends arc_Panel_slides
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section)
    {
...
//      }
  ...
  class arc_Panel_slides_bgimage extends arc_Panel_slides
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section)
    {
  ...
  class arc_Panel_slides_Content extends arc_Panel_slides
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section)
    {
      switch ($content_type) {
  ...
  class arc_Panel_slides_Excerpt extends arc_Panel_slides
  {
    /**
     * @param $component
     * @param $panel_def
...
//_panels_design_thumb-position
  ...
  class arc_Panel_slides_Custom extends arc_Panel_slides
  {
    public static function render($component, $panel_def, $content_type, &$data, &$section)
    {
