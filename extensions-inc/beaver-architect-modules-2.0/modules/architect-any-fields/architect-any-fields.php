<?php
  ...
  FLBuilder::register_module( 'FLArchitectAnyFieldsModule', array(
          'settings' => array(
            ...
            'description' => __( 'Due to the many ways to create custom fields, and many field field_types, Any Fields may not actually be able to display *any* field without enhancements. Therefore, please contact me if you encounter a field you cannot display.' ),
            // Tab title
            'sections'    => array(
              // Tab Sections
              'general'  => array(
