<?php
   ...
   * File: arc-slick-admin.php
   * User: chrishoward
   * Date: 15/05/15
   * Time: 8:17 PM
   */

  add_filter('arc-slider-engine', 'pzarc_slick');
  function pzarc_slick($sliders)
  {
    $sliders[ 'slick' ] = 'Slick';
//    var_dump($sliders);
  ...
  add_filter('arc-extend-slider-settings', 'pzarc_slick_slider_settings');
  function pzarc_slick_slider_settings($settings)
  {
