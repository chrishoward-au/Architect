<?php
  ...
  class PadmaArchitectBlock extends PadmaBlockAPI
  {
    ...
    function __construct(){
      ...
      $this->id = 'architect-block';
      $this->name = 'Architect';
      $this->options_class = 'PadmaArchitectBlockOptions';
      $this->description = 'Layout your content any way you want';
      $this->categories  = array('architect');      
...
//                                    ));
    ...
    function content($block)
    {
      ...
      if (function_exists('pzarc')) {
        echo pzarc($blueprint[ 0 ], $pzarc_overrides, 'padma-block', null, $settings, $blueprint_tablet[ 0 ], $blueprint_phone[ 0 ]);
