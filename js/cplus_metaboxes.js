    ...
    jQuery( ".cplus-dropzone").sortable({
      ...
      update: function(event,ui) {
			...
			create: function(event,ui) {
				...
				element_html['excerpt'] = '<span class="cplus-dropped cplus-dropped-excerpt"  title= "Post excerpt" data-idcode="%excerpt%" style="font-size:13px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam quis justo erat. Cras semper sem hendre...[more]</span>';
